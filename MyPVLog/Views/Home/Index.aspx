...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        Wichtig: Nach dem Umzug muss unbedingt im Client die Log Adresse mit der Subdomain "WWW" beginnen, also <strong>http://www.mypvlog.de/...</strong> sonst werden die Logs nicht gespeichert! Dies ist notwendig, damit das Portal den Azure Service kostenfrei nutzen kann. <br />
